...
const Faqs = () => {
  return <Box bg="#010a06" textAlign={"center"}>
          ...
          >
              ...
              <h2>
                <AccordionButton fontSize={{ lg: "24px",base:"17px",md:"19" }} p={{ lg: "30px",md:"20px",base:"20px"  }}>
                  <Box flex="1" textAlign="left" ml={{ lg: "-12px" }}>
                    Is Project pilot free for an unlimited number of users?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              </h2>
              <AccordionPanel pb={4} fontSize={{ lg: "15.36px" ,base:"14px",md:"15" }}>
              Project pilot is free for teams of up to 5 members.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              <h2>
                <AccordionButton fontSize={{ lg: "24px" ,base:"17px",md:"19px" }} p={{ lg: "30px" ,md:"20px" ,base:"20px" }}>
                  <Box flex="1" textAlign="left" ml={{ lg: "-12px" }}>
                    You mentioned that Project pilot is free for up to 5 users. If
            ...
            <AccordionItem>
              <h2>
                <AccordionButton fontSize={{ lg: "24px" ,base:"17px",md:"19px" }} p={{ lg: "30px",md:"20px" ,base:"20px"  }}>
                  <Box flex="1" textAlign="left" ml={{ lg: "-12px" }}>
                    Does Project pilot offer discounts?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              </h2>
              <AccordionPanel pb={4} fontSize={{ lg: "15.36px"  ,base:"14px",md:"15"}}>
                Yes, Project pilot offers discounts for nonprofits, students, and
                educational institutions. Visit this page to see if you can
                qualify. For those who do not qualify, Project pilot offers a
            ...
            <AccordionItem>
              <h2>
                <AccordionButton fontSize={{ lg: "24px"  ,base:"17px",md:"19" }} p={{ lg: "30px" ,md:"20px" ,base:"20px" }}>
                  <Box flex="1" textAlign="left" ml={{ lg: "-12px" }}>
                    Does Project pilot have desktop or mobile apps? Are they free?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              </h2>
            ...
            <AccordionItem>
              <h2>
                <AccordionButton fontSize={{ lg: "24px" ,base:"17px" ,md:"19" }} p={{ lg: "30px" ,md:"20px",base:"20px"  }}>
                  <Box flex="1" textAlign="left" ml={{ lg: "-12px" }}>
                    If I have a paid Project pilot Plan subscription, do I need to pay
                    for Project pilot?
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
              ...
              <AccordionPanel pb={4} fontSize={{ lg: "15.36px" ,base:"14px",md:"15" }}>
                Your Project pilot Plan subscription will not influence your Project pilot
                payment plan. You will need to sign up for a separate Project pilot
                account even if you have a Project pilot Plan account, and you
                will be billed separately according to the Project pilot Track plan
                you’re on. If you have a paid Toggl Plan subscription, you can
                take advantage of the Project pilot Plan and Track integration to track
                time within Plan.
              </AccordionPanel>
            </AccordionItem>
          </Accordion>
