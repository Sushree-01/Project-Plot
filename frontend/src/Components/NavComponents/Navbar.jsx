...
import Track from "../NavComponents/Track"
      ...
      <Box className={style.navbar_main1} >
        <Box className={style.navbar_sub2}  >
          ...
          <Drawer  placement={placement} onClose={onClose} isOpen={isOpen} >
            <DrawerOverlay />
              <DrawerContent minWidth={"100%"} backgroundColor={"#f0b38f"}>
          ...
          <Accordion
            ...
            style={
              ...
              nav === false
                ...
                : { borderTop: "0px solid rgb(205, 176, 218)" }
            }
            className={style.toogle1} >

            <NavLink to = "/produts"></NavLink>
          
            <AccordionItem style={{border:"none"}}>
              <h2 >
                <AccordionButton
                  background="rgb(165, 71, 208) "
                  border="#412a4c "
                  flex="1"
                  style={
                    nav === true
            ...
            <AccordionItem style={{border:"none"}}>
              ...
              <AccordionPanel className={style.button1} top={scrollPosition>=5&&"80px"} padding="0px" >
                <Box className={style.navbar_track}>
                  <Track />
                </Box>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem style={{border:"none"}}>
              ...
              <AccordionPanel className={style.button1} top={scrollPosition>=5&&"80px"}>
                <Box className={style.navbar_careers}>
                  <Career />
                </Box>
              </AccordionPanel>
            </AccordionItem>
